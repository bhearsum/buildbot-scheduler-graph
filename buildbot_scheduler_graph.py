...
def parse_schedulers(graph_info, schedulers, triggerables={}, sendchanges={}):
...
def main():
    ...
    parser.add_argument("master_cfg", nargs='+')
    ...
    graph_info = {}
    for c in args.master_cfg:
        master_cfg = os.path.abspath(c)
        ...
        try:
            ...
            graph_info = parse_schedulers(graph_info, cfg.c["schedulers"], triggerables=triggerables, sendchanges=sendchanges)
        finally:
            os.chdir(curdir)
